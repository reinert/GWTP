...
import com.github.reinert.ko.databind.client.Strategy;
import com.github.reinert.ko.gwtp.client.DatabindViewImpl;
...
public class CarMobileView extends DatabindViewImpl<CarUiHandlers> implements MyView {
    ...
    CarMobileView(Binder uiBinder) {
        ...
        bind("model", model, Strategy.ON_CHANGE);
        bind("manufacturer", manufacturer, Strategy.ON_CHANGE);
        bind("someString", someString, Strategy.ON_CHANGE);
        bind("someNumber", someNumber, Strategy.ON_CHANGE);
        bind("someDate", someDate, Strategy.ON_CHANGE);
    }
